...
2021 - Present: Built a blockchain based SaaS platform for Employee Rewards, Coalition Loyalty, and Point Exchange ([https://www.pravici.com](https://www.pravici.com)); Now gaining traction with half a dozen customers onboarded and growing  
Built Pravici PocketCred ([https://www.pocketcred.com](https://www.pocketcred.com)), a platform based on Verifiable Credentials for Health, Life Long Learning Credentials and more using SMART on FHIR ([https://spec.smarthealth.cards/]([SMART HEALTHCARD](https://spec.smarthealth.cards/))) standards.
